    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteOfficeForm" action="<?= base_url('office/updateClassification') ?>" method="post">
...
<div class="modal fade" id="editSubClassificationModal" tabindex="-1" role="dialog" aria-labelledby="editSubClassificationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editSubClassificationForm" action="<?= site_url('sub-classifications/update') ?>" method="post">
