                            ...
                            <?php foreach ($classifications as $classification): ?>
                                <?php if (!empty($classification['sub_classification'])): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('edit/' . $classification['classification_id']) ?>" class="btn btn-sm btn-primary">
                                                <span class="mdi mdi-pencil"></span> Edit
                                            </a>
                                            <a href="<?= base_url('delete/' . $classification['classification_id']) ?>" class="btn btn-sm btn-danger">
