                                ...
                                <tbody>
                                    <?php foreach ($documents as $document): ?>
                                        <tr>
                                            ...
                                            <td><span
                                                    class="status-badge status-<?= $document['status'] ?>"><?= ucfirst($document['status']) ?></span>
                                            </td>
                                        ...
                                        <!-- <tr class="pdf-row" style="display: none;">
                                            <td colspan="100%">
                                                <iframe class="pdf-viewer" style="width: 100%; height: 500px;"
                                                    src=""></iframe>
                                            </td>
                                        </tr> -->
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <!-- <h5 class="modal-title" id="pdfViewModalLabel">Document Versions
                                                        </h5> -->
    ...
    <div class="modal fade" id="editDocumentModal" tabindex="-1" role="dialog" aria-labelledby="editDocumentModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Your form here -->
                    <form id="editDocumentForm" action="<?= site_url('documents/updateDeptDocument') ?>" method="post"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" id="editRecipientOfficeId" name="recipient_office_id"
                                    required>
                                    <?php foreach ($officesDropdown as $office_id => $office_name): ?>
                                        <option value="<?= $office_id ?>"><?= $office_name ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" class="form-control-file" id="editAttachment" name="attachment"
                                    accept=".pdf">
                                <?php if (!empty($document['attachment'])): ?>
                                    <p>Current Attachment: <a href="<?= base_url('uploads/' . $document['attachment']) ?>"
                                            target="_blank"><?= $document['attachment'] ?></a></p>
                                <?php endif; ?>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="editDateOfDocument">Date of Document</label>
                                <input type="text" class="form-control" id="editDateOfDocument" name="date_of_document"
