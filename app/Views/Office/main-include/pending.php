                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <p class="card-description"> Documents awaiting action, approval, or completion before
                                moving to the next stage.</p>
                        </div>
                    </div>
                    <div class="table-responsive pt-3">
                        <table class="table table-striped project-orders-table" id="pending">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($documents as $document): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="status-badge status-<?= htmlspecialchars($document->status, ENT_QUOTES, 'UTF-8') ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <button type="button"
                                                    class="btn btn-success btn-sm btn-icon-text mr-3 receive-btn"
                                                    data-toggle="modal" data-target="#receiveDocumentModal"
...
<div class="modal fade" id="receiveDocumentModal" tabindex="-1" role="dialog"
    aria-labelledby="receiveDocumentModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="text-align: center; font-weight: bold; font-size: 1.2em;">Tracking Number: <span
                        id="trackingNumber"></span></p>
